...
public class TaskCreateActivity extends AppCompatActivity {
    ...
    void onSaveClick() {
        ...
        if (task.isReminder()) {
            // Funkcja getHour weszla dopiero w API 23 (nasze minimalne to 19) - istnieje wiec ryzyko
            // ze będziemy chcieli ją wywolać w systemie ktory nie posiada jej definicji.
            // Z tego wzgledu sprawdzamy bieżącą wersję systemu i jeżeli można to wywolujemy nową funkcję,
            ...
            if (reminderCalendar.before(Calendar.getInstance())) {
                Toast.makeText(this, "Data powiadomienia musi być poźniejsza niż teraz !", Toast.LENGTH_LONG)
                        .show();
                return;
            }
